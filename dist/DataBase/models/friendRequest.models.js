...
exports.FriendRequestSchema = exports.OnModelEnum = void 0;
...
exports.FriendRequestSchema.pre(["find", "findOne", "findOneAndDelete", "findOneAndUpdate"], function (next) {
...
const FriendRequestModel = mongoose_1.default.models.FriendRequest || mongoose_1.default.model("FriendRequest", exports.FriendRequestSchema);
