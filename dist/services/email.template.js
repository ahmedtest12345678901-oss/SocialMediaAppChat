...
const emailTemplate = (otp, title) => {
    return `<!DOCTYPE html>
                ...
                <table border="0" width="50%" style="margin:auto;padding:30px;background-color: #F3F3F3;border:1px solid #57db95ff;">
                <tr>
                <td>
...
<p style="margin:10px 0px 30px 0px;border-radius:4px;padding:10px 20px;border:0;color:#fff;background-color:#630E2B;">
  ${otp}
                ...
                <tr>
                <td>
                <h3 style="margin-top:10px; color:#000">:D in touch</h3>
                </td>
                </tr>
                <tr>
                <td>
